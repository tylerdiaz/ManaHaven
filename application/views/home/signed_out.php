<div style="background:#111 url(/images/mainart.jpg)no-repeat left center; color:#ccc; overflow:hidden; ">
...
$(document).ready(function()
{
	...
	$("#signup_button").live('click', function(){
	    var button_obj = $(this);
	    button_obj.animate({ opacity:0.5 }, 200).html('<img src="/images/ajax/getting_started_ajax.gif" alt="" width="16" height="16"> Creating character');
        $.ajax({
            type: "POST",
            ...
            success: function(json){
               if(json.errors != undefined){
           	       button_obj.animate({ opacity:1 }, 200).html('Start my character &rsaquo;')
                   alert(json.errors);
                   return false;
               } else {
                   // Classes removed
                   ...
                   //     $("#signup_block #sub_header").text('Modify your adventurer to your likes.');
                   // });
...
<style type="text/css" media="screen">
    ...
    #signup_block {
        ...
        background: -o-linear-gradient(top, rgba(0,0,0,0.75) 0%,rgba(0,0,0,0.95) 100%); /* Opera11.10+ */
        ...
        background: linear-gradient(top, rgba(0,0,0,0.75) 0%,rgba(0,0,0,0.95) 100%); /* W3C */ margin:0 0 0 -15px;
        min-height:300px;
    }
...
<div class="grid_2" id="signup_block">
    <h3 style="padding:0 10px 0; line-height:1.4; color:white" id="large_header">Join the adventure!</h3>
    <h5 style="border-bottom:1px solid #444; padding:0 10px 10px; margin-bottom:10px; font-weight:normal;" id="sub_header">Free to play forever. Play with friends. <!-- Unite with dozens of other players now! --></h5>
    <div id="signup_step1">
        <form id="signup_form_bones">
            <ul id="signup_form">
                <li>
                    <label for="signup_username">Username:</label>
                    <input type="text" name="username" id="signup_username" title="Only letters, numbers and spaces are allowed">
                </li>
                <li>
                ...
                <li>
                    ...
                    <input type="text" name="key" id="signup_beta_key" value="<?php echo (isset($_GET['invite']) ? htmlentities($_GET['invite']) : '') ?>">
                </li>
                <li>
    ...
    <script type="text/javascript" charset="utf-8">
        $(document).ready(function(){
            ...
            $("#complete_button").live('click', function(){
                var character_data = {
                    gender: used_gender,
                    character_class: active_class
                };
                
                $.ajax({
                    type: "POST",
                    url: baseurl+"auth/create_character/",
                    data: character_data,
                    cache: false,
                    async: true,
                    dataType: "json",
    ...
    <div id="signup_step2" style="display:none">
        ...
        <ul id="classes">
            <li id="adventurer"><a href="#"><?php echo image('signup/male/adventurer.png') ?></a></li>
            <li id="archer"><a href="#"><?php echo image('signup/male/archer.png') ?></a></li>
        ...
        <div id="class_contents">
            ...
            <div>
                ...
                <ul class="character_traits">
                    ...
                    <li style="background:#386326; font-size:11px; line-height:17px">Attacks air monsters</li>
                    <li style="background:#497848">Powerful skills</li>
        ...
        <button type="submit" id="complete_button" style="margin:20px 40px 0 0">Start playing now</button>
    </div>
</div>
...
<?php if ($this->input->get('logged_out')): ?>
    <script type="text/javascript" charset="utf-8">
        $(document).ready(function(){
            local_db.remove('preview_shop_item_data');
        });
    </script>
<?php endif ?>